        ...
        for letra in numRomano:      
            ...
            if letra in self.__valores:
                ...
                if ultimoCaracter == '':
                    ...
                    numRepes += 1
                    if letra in self.__valores_5 and ultimoCaracter in self.__valores_5: #solo deberiamos comprobar uno, porque en el elif ya dice que son iguales
                    ...
                    if ultimoCaracter in self.__valores_5: #no permite restas de valores de 5 (5, 50, 500)
